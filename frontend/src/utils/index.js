...
export function timeToDue(dueDate) {
  ...
  let text = ''
  let color = isOverdue ? 'text-red-600 font-semibold' : 'text-green-500'
  
  if (absDiff < 60) {
    text = isOverdue ? 'Overdue by seconds' : 'Due in seconds'
  } else if (absDiff < 3600) {
    let minutes = Math.floor(absDiff / 60)
    text = isOverdue ? `Overdue by ${minutes} minute${minutes !== 1 ? 's' : ''}` : `Due in ${minutes} minute${minutes !== 1 ? 's' : ''}`
  } else if (absDiff < 86400) {
    let hours = Math.floor(absDiff / 3600)
    ...
    let weeks = Math.floor(absDiff / 604800)
    text = isOverdue ? `Overdue by ${weeks} week${weeks !== 1 ? 's' : ''}` : `Due in ${weeks} week${weeks !== 1 ? 's' : ''}`
  } else if (absDiff < 31536000) {
    let months = Math.floor(absDiff / 2592000)
    text = isOverdue ? `Overdue by ${months} month${months !== 1 ? 's' : ''}` : `Due in ${months} month${months !== 1 ? 's' : ''}`
  } else {
    let years = Math.floor(absDiff / 31536000)
    text = isOverdue ? `Overdue by ${years} year${years !== 1 ? 's' : ''}` : `Due in ${years} year${years !== 1 ? 's' : ''}`
  }
