  ...
  >
    ...
    >
      ...
      >
          ...
          <div class="flex items-center justify-stretch gap-2 text-base">
            ...
            <div class="ml-auto whitespace-nowrap text-right">
              ...
              <div class="text-sm text-ink-gray-5">
                {{ formatDate(activity.creation, 'D MMM, hh:mm a') }}
              </div>
            </div>
          </div>
        </div>
        ...
        <div
          v-else-if="activity.activity_type == 'task_created'"
          class="mb-4 flex flex-col gap-2 py-1.5"
        >
          <div class="flex items-center justify-stretch gap-2 text-base">
            <div class="inline-flex items-center flex-wrap gap-1 text-ink-gray-5">
              ...
              <span>{{ __('created task') }}</span>
              <span class="font-medium text-ink-gray-8">
                {{ activity.data.title }}
              </span>
              <span v-if="activity.data.status" class="text-ink-gray-6">
                ({{ activity.data.status }})
              </span>
              <span v-if="activity.data.priority" class="text-ink-gray-6">
                - {{ activity.data.priority }} priority
              </span>
              <span v-if="activity.data.assigned_to" class="text-ink-gray-6">
                - {{ __('assigned to') }} {{ getUser(activity.data.assigned_to).full_name }}
              </span>
              <span v-if="activity.data.due_date" class="text-ink-gray-6">
                - {{ __('due') }} {{ formatDate(activity.data.due_date, 'D MMM, hh:mm a') }}
              </span>
            </div>
            <div class="ml-auto whitespace-nowrap text-right">
              <div class="text-base text-ink-gray-8 mb-1">
          ...
          <div v-if="activity.data.description" class="text-sm text-ink-gray-6 pl-4 border-l-2 border-outline-gray-modals">
            <div v-html="activity.data.description"></div>
          </div>
        </div>
        <div
          v-else-if="activity.activity_type == 'note_created'"
          class="mb-4 flex flex-col gap-2 py-1.5"
        >
          <div class="flex items-center justify-stretch gap-2 text-base">
            <div class="inline-flex items-center flex-wrap gap-1 text-ink-gray-5">
          ...
          <div v-if="activity.data.content" class="text-sm text-ink-gray-6 pl-4 border-l-2 border-outline-gray-modals">
            <div v-html="activity.data.content"></div>
          </div>
        </div>
        <div
          v-else-if="activity.activity_type == 'task_modified'"
          class="mb-4 flex flex-col gap-2 py-1.5"
        >
          <div class="flex items-center justify-stretch gap-2 text-base">
            <div class="inline-flex items-center flex-wrap gap-1 text-ink-gray-5">
              ...
              <span>{{ __('modified task') }}</span>
              <span class="font-medium text-ink-gray-8">
                {{ activity.subject?.replace('Modified task ', '') }}
              </span>
            </div>
            <div class="ml-auto whitespace-nowrap text-right">
              <div class="text-base text-ink-gray-8 mb-1">
          ...
          <div v-if="activity.content" class="text-sm text-ink-gray-6 pl-4 border-l-2 border-outline-gray-modals">
            {{ activity.content }}
          </div>
        </div>
        <div
          v-else-if="activity.activity_type == 'note_modified'"
          class="mb-4 flex flex-col gap-2 py-1.5"
        >
          <div class="flex items-center justify-stretch gap-2 text-base">
            <div class="inline-flex items-center flex-wrap gap-1 text-ink-gray-5">
              ...
              <span>{{ __('modified note') }}</span>
              <span class="font-medium text-ink-gray-8">
                {{ activity.subject?.replace('Modified note ', '') }}
              </span>
            </div>
            <div class="ml-auto whitespace-nowrap text-right">
              <div class="text-base text-ink-gray-8 mb-1">
        ...
        <div
          v-else-if="activity.activity_type == 'assignment_change'"
          class="mb-4 flex flex-col gap-2 py-1.5"
        >
          <div class="flex items-center justify-stretch gap-2 text-base">
            <div class="inline-flex items-center flex-wrap gap-1 text-ink-gray-5">
              ...
              <span class="font-medium text-ink-gray-8">
                {{ activity.subject?.replace('Assignment ', '') }}
              </span>
            </div>
            <div class="ml-auto whitespace-nowrap text-right">
              <div class="text-base text-ink-gray-8 mb-1">
...
function update_activities_details(activity) {
  ...
  if (activity.activity_type == 'creation') {
    ...
    activity.value = 'from'
    activity.to = 'to'
  } else if (activity.activity_type == 'task_created') {
    activity.type = 'created task'
    activity.value = activity.data.title
  } else if (activity.activity_type == 'note_created') {
    activity.type = 'created note'
    activity.value = activity.data.title
  } else if (activity.activity_type == 'task_modified') {
    activity.type = 'modified task'
    activity.value = activity.subject?.replace('Modified task ', '')
  } else if (activity.activity_type == 'note_modified') {
    activity.type = 'modified note'
    activity.value = activity.subject?.replace('Modified note ', '')
  } else if (activity.activity_type == 'assignment_change') {
    activity.type = 'assignment'
    activity.value = activity.subject?.replace('Assignment ', '')
  }
}
