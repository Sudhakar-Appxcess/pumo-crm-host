<template>
  <svg
    ...
    viewBox="0 0 16 16"
    fill="none"
    :class="status === 'Overdue' ? 'text-red-500' : 'text-ink-gray-7'"
    :aria-label="status"
  >
    <path
      v-if="status == 'Backlog'"
    ...
    <path
      ...
      fill="currentColor"
      fill-rule="evenodd"
      d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14Zm0-1.75a5.25 5.25 0 1 1 0-10.5 5.25 5.25 0 0 1 0 10.5ZM8 4.5a.75.75 0 0 0-.75.75v3c0 .414.336.75.75.75h2.5a.75.75 0 0 0 0-1.5H8.75V5.25A.75.75 0 0 0 8 4.5Zm0 6a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"
      clip-rule="evenodd"
    />
