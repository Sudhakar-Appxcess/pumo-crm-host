...
doc_events = {
	...
	"CRM Task": {
		"on_update": ["crm.api.activities.track_task_changes"],
	},
	"FCRM Note": {
		"on_update": ["crm.api.activities.track_note_changes"],
	},
}
...
# No scheduler needed - real-time validation handles everything
